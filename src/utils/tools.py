...
def get_body_params_pagination(action:str,params:dict,page:int,field_pagination:Optional[str]=None)->dict:
...
def get_total_pages(resource:str,action:str,params:dict,page_label:Optional[str]=None,total_of_pages_label:Optional[str]=None,records_label:Optional[str]=None)->int:
    ...
    api=Api(url=f"{settings.BASE_URL}{resource}",headers=HEADERS,json=payload,params=params)
